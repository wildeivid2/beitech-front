...
@Component({
  selector: 'app-ordenesmes',
  templateUrl: './ordenesmes.component.html'
})
export class OrdenesmesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.ordenService.consultarOrdenesDelMesPorCliente(this.idCliente).subscribe(
